# DentControl — passo a passo para colocar no ar (grátis)
...
> **Nome do paciente (novo):** rode também `supabase/migration_paciente.sql` no SQL Editor — adiciona o campo de nome do paciente em cada lançamento. Se está criando o banco do zero, ignore, o `schema.sql` já vem completo.
