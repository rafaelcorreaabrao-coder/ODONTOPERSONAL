      ...
      <Card style={{ width: "100%", maxWidth: 380 }}>
        <div style={{ marginBottom: 18 }}>
          ...
          <div style={{ fontSize: 13, color: t.textMuted, marginTop: 4 }}>
            Esse é o nome que identifica você dentro do DentControl. Precisa ser exclusivo — algo como o nome da sua clínica pessoal ou como você é conhecida profissionalmente.
          </div>
        </div>
